...
public class preop_GotoClinic extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_preop__goto_clinic);
    ...
    void UploadDataToServer()
    {
        ...
        JpParams.put("AlertMsgFromPtToServ","Please Contact patient to book appointment");
